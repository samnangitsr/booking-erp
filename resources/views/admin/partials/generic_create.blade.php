...
@section('pageHeading', __('admin.common.add') . ' — ' . __('admin.nav.'.$heading))
@section('pageTitle', __('admin.common.add') . ' — ' . __('admin.nav.'.$heading))

@section('breadcrumb_items')
    <li class="breadcrumb-item"><a href="{{ url()->previous() }}">{{ __('admin.nav.'.$heading) }}</a></li>
    <li class="breadcrumb-item active" aria-current="page">{{ __('admin.common.add') }}</li>
@endsection
